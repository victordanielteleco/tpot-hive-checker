...
probe_http() {
  ...
  run_cmd \
    ...
    "Generar un acceso web benigno y obtener cabeceras / respuesta para que el honeypot registre actividad" \
...
probe_telnet_like() {
  run_cmd \
    ...
    "Forzar un banner / conexión Telnet sin necesidad de interactuar manualmente" \
...
# Redirigimos la salida a consola y log
...
echo "     source.ip: ${TARGET}  (si filtras por destination, ajústalo a tu caso)"
echo "     cowrie"
echo "     dionaea"
echo "     elasticpot"
echo "     honeyaml"
